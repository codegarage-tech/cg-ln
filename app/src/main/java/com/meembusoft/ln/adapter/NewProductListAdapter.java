...
import com.meembusoft.ln.viewholder.NewProductViewHolder;
...
public class NewProductListAdapter extends RecyclerArrayAdapter<Product> {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_REGULAR:
                return new NewProductViewHolder(parent);
            default:
