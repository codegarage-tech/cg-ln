...
import com.meembusoft.ln.viewholder.OrderDetailItemViewHolder;
...
public class OrderDetailItemListAdapter extends RecyclerArrayAdapter<OrderItem> {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_REGULAR:
                return new OrderDetailItemViewHolder(parent);
            default:
