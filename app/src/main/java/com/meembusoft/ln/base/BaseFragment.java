...
import com.meembusoft.ln.base.interfaces.OnFragmentBackPressedListener;
import com.meembusoft.ln.base.interfaces.OnFragmentResultListener;
import com.meembusoft.ln.base.interfaces.OnFragmentUpdateListener;
...
public abstract class BaseFragment extends Fragment implements OnFragmentBackPressedListener, OnFragmentResultListener, OnFragmentUpdateListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Logger.d(TAG, TAG + " >>> " + "BaseFragment: Called onCreate");
    }
...
//        containerView = DataBindingUtil.inflate(inflater, initFragmentLayout(), container, false).getRoot();
        ...
        Logger.d(TAG, TAG + " >>> " + "BaseFragment: Called onCreateView");
