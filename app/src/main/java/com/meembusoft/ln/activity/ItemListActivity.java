...
import com.meembusoft.ln.adapter.CategoryPagerAdapter;
import com.meembusoft.ln.adapter.ItemAdapter;
import com.meembusoft.ln.adapter.OrderAdapter;
import com.meembusoft.ln.model.Category;
import com.meembusoft.ln.model.Item;
import com.meembusoft.ln.model.Order;
import com.meembusoft.ln.model.Solution;
import com.meembusoft.ln.model.SubCategory;
import com.meembusoft.ln.util.CircleAnimationUtil;
...
public class ItemListActivity extends AppCompatActivity implements ItemAdapter.IItemAdapterCallback, OrderAdapter.IOrderAdapterCallback
{
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // set
        rvOrder.setLayoutManager(new LinearLayoutManager(ItemListActivity.this));
        orderAdapter = new OrderAdapter(ItemListActivity.this, orderList);
        ...
        CategoryPagerAdapter categoryPagerAdapter = new CategoryPagerAdapter(getSupportFragmentManager(), ItemListActivity.this, solutionList);
    ...
    */
    private void showMessage(Boolean isSuccessful, String message)
    {
        ...
        if (isSuccessful)
        {
            snackbar.getView().setBackgroundColor(ContextCompat.getColor(ItemListActivity.this, R.color.colorAccent));
        } else
        {
            snackbar.getView().setBackgroundColor(ContextCompat.getColor(ItemListActivity.this, R.color.colorPomegranate));
        }
