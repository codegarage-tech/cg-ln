...
import com.meembusoft.ln.controller.ProductDetailController;
...
public class CategoryActivity extends BaseActivity implements AAH_FabulousFragment.Callbacks, AAH_FabulousFragment.AnimationListener {
    ...
    public void initViewsData(Bundle savedInstanceState) {
        ...
        mProductDetailController = new ProductDetailController(getActivity(), getParentView());
        updateFoldingView(true);
...
//                            }
    ...
    public void openProductDetail(View rowItemView, Product product) {
        mProductDetailController.openDetails(rowItemView, product);
    }

    public void updateFoldingView(boolean isFolded) {
        if (isFolded) {
