...
//    private SwitchIconView switchStopNotification;
    ...
    private RelativeLayout rlLoginOrCreateAccount, rlAboutProfile, rlOrders, rlFavoriteProduct, rlStopNotification, rlAppNotifications, rlAboutApp, rlDownloadApp, rlSupport;
