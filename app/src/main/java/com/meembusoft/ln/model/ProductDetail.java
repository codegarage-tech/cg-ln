...
public class ProductDetail implements Suggestion, Comparable<ProductDetail> {
    ...
    public ProductDetail(int id, String name, boolean isFavorite, boolean hasOffer, List<Image> images, String vendor, String note, boolean hasDependency, boolean availability, List<Unit> units) {
        this.id = id;
        this.name = name;
